...
def get_serializer_class(model, fields="__all__"):
    return type(
...
for model, model_admin in admin.site._registry.items():
    fields = list(model_admin.get_fieldsets(r))
    ...
    params = {
        ...
        "serializer_class": get_serializer_class(model,fields=flatten_fieldsets(fields)),
    ...
    #             template_name="django_contrib_admin_react/list.html",
    #             extra_context={
    ...
    #         TemplateView.as_view(
    #             template_name="django_contrib_admin_react/edit.html",
    #             extra_context={
    #                 "create": True,
    #                 "app": model._meta.app_label,
    #                 "model": model._meta.model_name,
